        ...
        <div class="mx-auto max-w-sm p-6 bg-white border border-b-0 border-gray-200 rounded-t-lg shadow">
            <form method="POST" action="{{ route('customer.login') }}">
                ...
                <div class="mb-6 text-center">
                    <div class="text-2xl font-extrabold">{{ __('website.Welcome To') }}
                        {{ $setting->getValue('G_SITE_NAME') }}</div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input type="email" id="email"
                        ...
                        placeholder="your@email.com" required name="email" value="{{ old('email') }}">
                </div>
                <div class="mb-6">
                    <label for="password"
                ...
                <div class="mb-6 flex justify-between">
                    ...
                    <a href="{{ route('customer.forgot-password.index') }}"
                        class="text-sm font-medium text-gray-900 dark:text-gray-300 hover:underline">
                        {{ __('website.Forgot Password')}}
                    </a>
                </div>
                <button type="submit"
                    class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">{{ __('website.Login') }}</button>
            </form>
        </div>
