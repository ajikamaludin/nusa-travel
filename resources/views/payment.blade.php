...
@section('content')
    <div class="w-full mx-auto max-w-7xl px-2 py-5">
        <div class="mx-auto p-6 flex flex-col">
            <div class="font-bold text-3xl mb-5" id="wait">Waiting Payment ....</div>
            <div class="font-bold text-2xl" id="status"></div>
            <div class="w-full flex mt-4">
                <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 hidden" id="pay-button">Process Payment</button>
            </div>
        </div>
    </div>
@endsection
