    ...
    <div class="px-4">
        <form action="{{route('customer.profile')}}" method="POST">
            ...
            <div class="grid gap-6 mb-2 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" id="national_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="{{ __('website.National ID')}}" name="national_id" value="{{ $customer->national_id }}">
                </div>
                
            </div>
            <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{{ __('website.Save')}}</button>
        </form>
        ...
        <form action="{{ route('customer.password') }}" method="POST">
            ...
            <div class="grid gap-6 mb-2 mt-6 md:grid-cols-2">
                ...
                <div>
                    <label for="password_confirmation" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('website.Confirm password')}}</label>
            ...
            <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{{ __('website.Change Password')}}</button>
