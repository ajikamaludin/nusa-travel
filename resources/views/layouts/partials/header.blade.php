...
<div class="sticky top-0 z-50 shadow bg-white">
        ...
        <div class="flex flex-row max-w-7xl mx-auto w-full justify-between items-center ">
            ...
            <div class="lang-container flex-row gap-1 items-center">
                ...
                <div id="dropdownuser" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                    ...
                    <li>
                        <a href="{{ route('customer.profile') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">{{ __('website.Profile') }}</a>
                    </li>
                    <li>
                        <a href="{{ route('customer.orders') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">{{ __('website.Order') }}</a>
                    </li>
                    <li>
    ...
    <div class="menu-container flex-row gap-2 items-center border-b-2 border-gray-100 px-2 lg:px-16 overflow-auto">
        <div class="flex flex-row max-w-7xl mx-auto w-full items-center font-bold">
            ...
            <a href="{{ route('fastboat') }}" class="my-1 px-4 py-2 cursor-pointer rounded text-sm text-gray-900 focus:outline-none bg-white hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:text-white">
                {{ __('website.Fastboat') }}
            </a>
            ...
            <a href="{{ route('page.show', ['page' => 'schedule']) }}" class="my-1 px-4 py-2 cursor-pointer rounded text-sm text-gray-900 focus:outline-none bg-white hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:text-white">
                {{ __('website.Schedule')}}
            </a>
        </div>
    </div>
...
<div id="drawer-navigation" class="fixed top-0 left-0 z-50 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white w-full dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-navigation-label">
    ...
    <div class="py-4 overflow-y-auto">
        <ul>
            ...
            <li>
                <a href="{{ route('fastboat') }}" class="flex items-center py-4 px-2 text-base font-normal text-gray-900 rounded-lg hover:bg-gray-100">
            ...
            <li>
                <a href="{{ route('page.show', ['page' => 'schedule']) }}" class="flex items-center py-4 px-2 text-base font-normal text-gray-900 rounded-lg hover:bg-gray-100">
