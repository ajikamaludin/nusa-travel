    ...
    return (
        <div>
            ...
            <div className="flex flex-row gap-1">
                <select value={clock} onChange={e => selectTime(e.target.value, 'c')} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    {clocks.map(c => (
                        <option key={c} value={c}>{c}</option>
                    ))}
                </select>
                <select value={minute} onChange={e => selectTime(e.target.value, 'm')} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    {minutes.map(m => (
