...
export default function Index(props) {
    ...
    const onDelete = () => {
        if(confirmModal.data !== null) {
            router.delete(route('fastboat.place.destroy', confirmModal.data.id))
        }
    }
                        ...
                        <div className='overflow-auto'>
                            <div>
                                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400 mb-4">
                                    ...
                                    <tbody>
                                        {data.map(place => (
                                            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700" key={place.id}>
                                                ...
                                                <td className="py-4 px-6 flex justify-end">
                                                    ...
                                                    >
                                                        {canUpdate && (
                                                            <Dropdown.Item onClick={() => toggleFormModal(place)}>
                                                        ...
                                                        {canDelete && (
                                                            <Dropdown.Item onClick={() => handleDeleteClick(place)}>
                                                                <div className='flex space-x-1 items-center'>
                                                                    <HiTrash/> 
                                                                    <div>Hapus</div>
                                                                </div>
